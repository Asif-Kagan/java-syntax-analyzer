...
/**
 * While node for the AST.
 * describes an while statement
 */
public class While implements Statement, Node {
    /** the boolean expression of the while's condition */
    private BooleanExpression expression;
    /** the while's code block */
    private Block block;

    /**
     * add a boolean expression as the while's condition
    ...
    /**
     * add a code block to this while
